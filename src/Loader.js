  ...
  return (
    <Container>
        ...
        <circle cx="50" cy="50" r="30" stroke="#70c0f6" strokeWidth="9" strokeLinecap="square" fill="none">
            <animateTransform attributeName="transform" type="rotate" repeatCount="indefinite" dur="2.3333333333333335s" values="0 50 50;180 50 50;720 50 50" keyTimes="0;0.5;1"></animateTransform>
